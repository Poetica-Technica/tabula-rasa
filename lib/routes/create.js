...
const { randomItem, getRandomPoemByAuthor } = require('./route-functions.js');

module.exports = Router()

  // i.e. /api/v1/create/?author=Shakespeare
  .get('/', ensureAuth, (req, res, next) => {
    // Check for 'random' request and redirect to fullyRandom route, preserving format query param
