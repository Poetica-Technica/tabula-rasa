...
schema.methods.formatted = async function(format = 'json') {
  ...
  if(format === 'tweet') {
    ...
    console.log('twitterResponse is', twitterResponse);
    console.log('twitterResponse.entities is', twitterResponse.entities);
    console.log('twitterResponse.entities.urls is', twitterResponse.entities.urls);
    console.log('twitterResponse.entities.urls.expanded_url is', twitterResponse.entities.urls.expanded_url);
